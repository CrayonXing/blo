                ...
                <section class="layui-card">
                    ...
                    <div class="layui-card-body" style="height: 350px;">
                        <table class="layui-table new-article" lay-skin="nob">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $newArticle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($article->nickname); ?></td>
                                        <td><?php echo e($article->category_name); ?></td>
                                        <td><?php echo e($article->created_time); ?></td>
                                        <td><a href="/article/details/aid/<?php echo e($article->id); ?>" style="color: #7dc5f1" target="_blank"><?php echo e($article->title); ?></a></td>
                                    </tr>
