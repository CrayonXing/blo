...
@push('css')
    <link href="{{asset('static/admin/css/hadmin-bootstrap.min.css?v=3.3.6')}}" rel="stylesheet">
    <link href="{{asset('static/admin/css/hadmin-style.css?v=4.1.0')}}" rel="stylesheet">
    ...
    <style>
        ...
        .mobile-menu-preview{
            ...
            width: 317px;
            height: 550px;
            background: transparent url(/static/admin/image/wx_mobile_header_bg.png) no-repeat 0 0;
        ...
        .mobile-menu-preview .menu-list {
            ...
            background: transparent url(/static/admin/image/wx_mobile_footer_bg.png) no-repeat 0 0;
            background-position: 0 0;
        ...
        .menu-item .icon-menu-dot{
            background: url(/static/admin/image/wx_mobile_index.png) 0 0 no-repeat;
            width: 7px;
            height: 7px;
            vertical-align: middle;
        ...
        .weixin-icon{
            background: url(/static/admin/image/weixin_icon.png) 0 -4418px no-repeat;
            width: 16px;
            height: 16px;
            vertical-align: middle;
            display: inline-block;
        ...
        .weixin-icon.sort-gray {
            background: url(/static/admin/image/weixin_icon.png) 0 -32px no-repeat;
...
@section('content')
    <div style="padding: 10px;">
        <div class="layui-row larryms-panel" style="border-radius: 0;">
            <div class="larryms-panel-heading layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12 " style="background-color: #99c5ff !important;">
                <span class="panel-tit" style="color: #FFFFFF">微信公众号菜单配置</span>
            </div>
                                        ...
                                        <div class="ibox-content" style="padding: 15px;min-height: 400px;">
                                            ...
                                            <form class="form-horizontal" onsubmit="return false;">
                                                ...
                                                <div class="cus-menu-box form-group hidden">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <label class="checkbox-inline hidden"><input type="radio" value="click" name="type" > 发送消息</label>
                                                        ...
                                                        <label class="checkbox-inline hidden"><input type="radio" value="scancode_push" name="type"> 扫码推</label>
                                                        <label class="checkbox-inline hidden"><input type="radio" value="scancode_waitmsg" name="type"> 扫码推提示框</label>
                                                        <label class="checkbox-inline hidden"><input type="radio" value="pic_sysphoto" name="type"> 拍照发图</label>
                                                        <label class="checkbox-inline hidden"><input type="radio" value="pic_photo_or_album" name="type"> 拍照相册发图</label>
                                                        <label class="checkbox-inline hidden"><input type="radio" value="pic_weixin" name="type"> 相册发图</label>
                                                        <label class="checkbox-inline hidden"><input type="radio" value="location_select" name="type"> 地理位置选择</label>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="my-box-type3 my-box">
                                                            ...
                                                            <div style="width: 292px;height: 137px;background:white;margin: 0 auto;border: 1px dashed #f1e1e1;">
                                                                ...
                                                                <div style="width: 100%;cursor: pointer" id="fr-menu-resources">
                                                                    <p><i class="icon larry-icon larry-fabuxinneirong" style="font-size: 26px;color: #91cdeb;margin-left: 136px;margin-top: 20px;"></i></p>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        // var menuJson = '{"button":[{"name":"\u4e00\u7ea7\u83dc\u5355","sub_button":{"list":[{"type":"view","name":"\u4eca\u65e5\u5934\u6761","url":"https:\/\/www.toutiao.com\/"},{"type":"view","name":"\u6dfb\u52a0\u5b50\u83dc\u5355","url":"https:\/\/www.toutiao.com\/"}]}},{"name":"\u5b98\u7f51","sub_button":{"list":[{"type":"view","name":"\u540e\u53f0","url":"https:\/\/www.toutiao.com\/"}]}},{"type":"view","name":"\u7f51\u7ad9","url":"http:\/\/47.105.180.123"}]}';

        // var menuJson = '{"button":[{"name":"一级菜单","sub_button":[{"type":"click","name":"活动一","key":"key|","sub_button":[]},{"type":"click","name":"活动二","key":"key|","sub_button":[]},{"type":"view","name":"活动三","url":"http://172.16.100.85/weixin","sub_button":[]}]},{"name":"官网","sub_button":[{"type":"view","name":"微信端","url":"http://172.16.100.85/weixin","sub_button":[]},{"type":"click","name":"PC端","key":"key|","sub_button":[]}]},{"name":"网站","sub_button":[{"type":"view","name":"百度网站","url":"https://news.baidu.com/","sub_button":[]},{"type":"view","name":"新浪新闻","url":"https://news.sina.com.cn/","sub_button":[]},{"type":"view","name":"腾讯新闻","url":"https://news.qq.com/","sub_button":[]},{"type":"miniprogram","name":"跳转小程序","url":"http://47.105.180.123/admin","appid":"AKASDAS1A1S5FA1531DA","pagepath":"http://47.105.180.123","sub_button":[]},{"type":"view","name":"添加子菜单","url":"发送到","sub_button":[]}]}]}';

        // var menuJson = '{"button":[{"name":"\u4e00\u7ea7\u83dc\u5355","sub_button":{"list":[{"type":"view","name":"\u4eca\u65e5\u5934\u6761","url":"https:\/\/www.toutiao.com\/"},{"type":"view","name":"\u6dfb\u52a0\u5b50\u83dc\u5355","url":"https:\/\/www.toutiao.com\/"}]}},{"name":"\u5b98\u7f51","sub_button":{"list":[{"type":"view","name":"\u540e\u53f0","url":"https:\/\/www.toutiao.com\/"}]}},{"type":"view","name":"\u7f51\u7ad9","url":"http:\/\/47.105.180.123"}]}';

        // console.log(JSON.parse(menuJson))
