...
@section('content')
    ...
    <article>
        ...
        <div class="web-main-right">
            ...
            <div class="web-main-content" style="padding: 20px 10px 20px 10px;">
                <div class="am-g">
                    <div class="am-u-sm-8">
...
@push('scripts')
    <script type="text/javascript" src="http://cdn.clouddeep.cn/amazeui/2.7.2/js/amazeui.min.js"></script>
