<div class="web-main-left">
  ...
  <div class="web-main-nav">
      <ul>
        ...
        <li @if(request()->path() == 'user-article') class="web-main-nav-current" @endif><a href="/user-article">我的文章</a></li>
        ...
        <li @if(request()->path() == 'user-info') class="web-main-nav-current" @endif>个人资料</li>
