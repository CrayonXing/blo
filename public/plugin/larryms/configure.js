layui.define(function(exports){
    exports('configure',{
        ...
        basecore:'core',//用户自定义全局公共核心模块文件（默认为未设置，可作为larryms的扩充）
        modsname: layui.cache.mods !== undefined ? layui.cache.mods : 'admin/',//项目模块存放目录名
        modscore: false,//项目公共模块默认开启，如需关闭请设置modscore:false
        ...
        fontUrl:'//at.alicdn.com/t/font_477590_n82storgbj.css',//可以根据需要使用自定义路径但不建议在此修改，可根据文档在项目公共模块中设置自定义字体库url
        ...
        //主框架相关主题初始化参数
        rightMenu:false,//页面右键功能是否开启，默认开启larryMenu右键菜单功能，用户可在core.js中自定义
        pageCrumbs:false,//用于页面是否开启面包屑导航，仅建议在无选项卡布局下根据需要启用，或通过具体页面入口配置参数控制
        iframeFixBar:true,//iframe页面右下角工具条默认关闭
        topMenuSet:false,//开启顶部导航菜单，建议使用顶部导航菜单
