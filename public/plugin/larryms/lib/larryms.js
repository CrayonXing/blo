layui.define(["jquery", "layer", "laytpl", "element", "configure"], function(e) {
    var x = layui.$,
        s = layui.layer,
        w = layui.laytpl,
        k = layui.device(),
        ...
        o = function() {
            this.version = "LarryMS 2.1.0 rc_01", this.sysName = d.sysTipsName !== undefined ? d.sysTipsName : "LarryMS", this.tit = [this.sysName + "提示您", this.sysName + "错误提示", this.sysName + "参数配置错误提示", this.sysName + "数据源配置错误", "关闭失败提示", "操作成功", "操作失败", this.sysName + " Ajax 调试信息控制台"], this.config = {
                plusDir: layui.cache.base + "plus/",
                jqDefined: undefined,
                jqUrl: undefined
    ...
    o.prototype.placeholder = function() {
        var e = this,
            r = "";
        x("input.larryms-input,input.larry-input,textarea.larry-textarea,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("focus", function() {
            r = x(this).attr("placeholder");
            x(this).attr("placeholder", "")
        });
        x("input.larryms-input,input.larry-input,textarea.larry-textarea,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("blur", function() {
    ...
    o.prototype.plugin = function(e, r, t) {
        ...
        if (x.isPlainObject(t)) {
            ...
            s.src = o;
            s.id = "larryms_" + e.substring(0, e.lastIndexOf(".js"));
            s.async = false;
    ...
    o.prototype.elemCheck = function(e, r) {
        ...
        if (t.length === 0) {
            if (d.debug) {
                ...
                n.hint("您虽然设置了" + r + "参数，但DOM中却查找不到定义的【" + e + "】元素,请仔细检查")
            }
            t = "error";
            return t
        }
    ...
    o.prototype.hint = function(e) {
        var r = this;
        if (r.typeFn.browser().name == "chrome") {
            console.error(r.sysName + "系统提示您:" + e)
        } else {
            return {
                tips: e
            }
    ...
    o.prototype.confirm = function(e, r, t, n) {
        ...
        x.extend(i, r);
        return index = s.confirm(e, i, function() {
    ...
    o.prototype.typeFn = {
        ...
        browserType: function() {
            ...
            var s = e.indexOf("Chrome") > -1 && e.indexOf("Safari") > -1;
            if (t) {
        ...
        browser: function() {
            ...
            if (/(msie|chrome|firefox|opera|netscape)\D+(\d[\d.]*)/.test(e)) {
                r[RegExp.$1] = true;
                r.name = RegExp.$1;
                r.version = RegExp.$2
            } else if (/version\D+(\d[\d.]*).*safari/.test(e)) {
                r.safari = true;
                r.name = "safari";
                r.version = RegExp.$2
            }
    ...
    o.prototype.isUrl = function(e) {
        var r = this;
        if (r.typeFn.isObj(e)) {
            return "obj"
        } else {
            if (!r.typeFn.isString(e)) {
                return false
            }
        }
    ...
    o.prototype.utils = {
        fixbar: function(t) {
            var e = "larryms-fixbar",
                ...
                a = x("body"),
                i, o;
            if (d.iframeFixBar == false) return false;
            t = x.extend({
                showHeight: 200
            }, t);
            ...
            var s = [t.bar1, t.bar2, "larry-fanhuidingbu"],
                l = x(['<ul class="' + e + '">', t.bar1 ? '<li class="backControl" lay-type="bar1" style="' + t.bgcolor + '" ' + t.custom + "><em>返回首页</em></li>" : "", t.bar2 ? '<li class="layui-icon ' + s[1] + '" lay-type="bar2" style="' + t.bgcolor + '" ' + t.custom + "></li>" : "", '<li class="larry-icon ' + s[2] + '" id="' + r + '" lay-type="top" style="' + t.bgcolor + '"></li>', "</ul>"].join("")),
                c = l.find("#" + r),
                u = l.find(".backControl");
            ...
            if (x("." + e)[0]) return;
            typeof t.css === "object" && l.css(t.css);
            a.append(l), scroll();
        ...
        getUrlAllParams: function(e) {
            ...
            for (var a = 0, i = t.length; a < i; a++) {
                ...
                var s = t[a].substring(0, o),
                    l = window.decodeURIComponent(t[a].substring(o + 1));
                n[s] = l
            }
            return n
        },
    ...
    o.prototype.notice = function(e, r, t, n) {
        ...
        switch (i.msgtype) {
            ...
            case "error":
                ...
                break;
            case "warning":
                l = "larryms-msg-warning";
                o.icon = "larry-jinggao5";
                break;
            case "danger":
                l = "larryms-msg-danger";
                o.icon = "larry-zhongyao";
                break;
            default:
                l = "larryms-msg-" + i.msgtype;
                break
        }
        var c = "";
        if (i.bgcolor !== false) {
